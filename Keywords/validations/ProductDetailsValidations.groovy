...
public class ProductDetailsValidations {
	public static void verifyContainsOneOfTags(String tag) {
		List <WebElement> tagsWebElements = WebUI.findWebElements(findTestObject("Object Repository/ProductDetailsPage/span_itemProperties"),
